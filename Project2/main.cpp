...
int main() {
    ...
    if (!X_15Up.loadFromFile("X_15Up.jpg") ||
        !X_10Up.loadFromFile("X_10Up.jpg") ||
        !Random_10Up.loadFromFile("Random_10Up.jpg") ||
        !Random_10Down.loadFromFile("Random_10Down.jpg") ||
        !All_15Up.loadFromFile("All_15Up.jpg") ||
        !Button6.loadFromFile("Button.png") ||
        !ButtonHover7.loadFromFile("ButtonHover.png") ||
        !Button8.loadFromFile("Button.png") ||
        !ButtonHover9.loadFromFile("ButtonHover.png") ||
        !Button10.loadFromFile("Button.png") ||
        !ButtonHover11.loadFromFile("ButtonHover.png") ||
        !Button12.loadFromFile("Button.png") ||
        !ButtonHover13.loadFromFile("ButtonHover.png") ||
        !Button14.loadFromFile("Button.png") ||
        !ButtonHover15.loadFromFile("ButtonHover.png"))
    {
        return -1;
    }
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (button1 == true)
            {
                window.draw(X_10UpSprite);
                window.draw(sprite8);
            }
            if (button2 == true)
            {
                window.draw(Random_10UpSprite);
                window.draw(sprite10);
            }
            if (button3 == true)
            {
                window.draw(Random_10DownSprite);
                window.draw(sprite12);
            }
            if (button4 == true)
            {
                window.draw(All_15UpSprite);
